...
The application includes a full OCPP 1.6J WebSocket server implementation. For detailed information about the OCPP server, including connection details, supported messages, and testing instructions, see [OCPP_README.md](HASmartCharge.Backend/OCPP_README.md).

Quick start:
- **WebSocket Endpoint**: `ws://localhost:5000/ocpp16/{chargePointId}`
